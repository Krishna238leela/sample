...
<meta name="twitter:description" content="Uniting Communities, Preserving Traditions" />
  ...
  <body>
    ...
    <?php include("includes/header.php"); ?>
      <!-- Breadcrumbs -->
      <section class="breadcrumbs-custom bg-image context-dark" style="background-image: url(images/communityfullview-banner.jpg);">
        <div class="breadcrumbs-custom-inner">
          <div class="container breadcrumbs-custom-container">
            <div class="breadcrumbs-custom-main">
              <h6 class="breadcrumbs-custom-subtitle title-decorated">News</h6>
              <h1 class="breadcrumbs-custom-title">Backed by Community Support</h1>
            </div>
            <!--<ul class="breadcrumbs-custom-path">
              <li><a href="index.html">Home</a></li>
              <li><a href="#">News</a></li>
              <li class="active">Backed by Community Support</li>
            </ul>-->
          </div>
        </div>
      </section>
              ...
              <article class="post-creative">
                ...
                <ul class="post-creative-meta">
                  <li><span class="icon mdi mdi-calendar-clock"></span>
                    <time datetime="2023">Nov 8, 2023 </time>
                  </li>
                  <li><span class="icon mdi mdi-tag-multiple"></span><a href="community-supportblog.php">News</a></li>
                </ul>
                <h4>Backed by Community Support:</h4><img src="images/community-fullview.jpg" alt="" width="770" height="458"/>
                <p>The launch of this initiative was made possible through the generous support and contributions from the HinduCC community. Volunteers and donors rallied together to ensure that the Emergency Shelters for Women program could fulfill its mission of providing a secure and supportive environment.</p>
				<!-- Quote Light-->
...
<a href="empowering-womenblog.php" class="blog-thumb">
<img src="images/empowering-women.jpg" alt="blog image">
</a>
<div class="info">
<time datetime="2021-04-08">Oct 9, 2023</time>
<h4>
<a href="empowering-womenblog.php">Empowering Women in Times of Need</a>
</h4>
</div>
</article>
